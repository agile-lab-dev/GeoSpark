...
object OSMStreetType extends Enumeration {
    ...
    val Motorway, Secondary, Unclassified, Tertiary, Primary_link, Primary, Track, Residential = Value
}
...
case class OSMStreet(lineString: MultiLineString, street: String, speedLimit: Int, bidirected: Boolean, streetType: OSMStreetType) extends Geometry(lineString.getFactory) {
